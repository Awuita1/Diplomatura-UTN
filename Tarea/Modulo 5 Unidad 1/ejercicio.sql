...
-- Tiempo de generación: 15-10-2024 a las 15:58:25
...
CREATE TABLE IF NOT EXISTS `empleados` (
  ...
  `apellido` varchar(250) COLLATE utf8mb3_spanish_ci NOT NULL,
  `trabajo` varchar(250) COLLATE utf8mb3_spanish_ci NOT NULL,
  `edad` int NOT NULL,
  `salario` int NOT NULL,
  `mail` varchar(250) COLLATE utf8mb3_spanish_ci NOT NULL,
  PRIMARY KEY (`id_emp`)
...
(5, 'Alfred', 'Fernandez', 'Progrador', 31, 75000, 'af@bignet.com'),
